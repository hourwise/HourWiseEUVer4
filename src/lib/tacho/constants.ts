...
export const ACTIVE_DRIVING_STILL_THRESHOLD_KMH = 1.5;
export const LOW_SPEED_STOP_THRESHOLD_KMH = 6;
export const MOVING_CONFIRM_MS = 1200;
export const STATIONARY_CONFIRM_MS = 8000;
export const DRIVING_STOP_TAIL_MS = 8000;
export const BACKGROUND_SAMPLE_STALE_MS = 10000;
export const GPS_STALE_THRESHOLD_MS = 4000;
