...
export const loadScheduledComplianceNotificationIds = async () => {
  try {
    ...
    console.warn('Failed to load scheduled notification IDs:', e);
    return [] as string[];
  }
};
...
export const saveScheduledComplianceNotificationIds = async (ids: string[]) => {
  try {
    ...
    console.error('Failed to save scheduled notification IDs:', e);
  }
};
...
export const clearScheduledComplianceNotificationIds = async () => {
  try {
    ...
    console.error('Failed to clear scheduled notification IDs:', e);
  }
};
